...
def get_search():
    ...
    print("[Info] {0} Results Found".format(data_total))
    if data_total > 1000:
        pages = 24
    ...
    for p in range(pages):
        ...
        url = "https://www.linkedin.com/voyager/api/search/cluster?count=40&guides=List()&keywords=%s&origin=GLOBAL_SEARCH_HEADER&q=guided&searchId=1489295486936&start=%i" % (
            search, p * 40)
        url = "https://www.linkedin.com/voyager/api/search/cluster?count=40&guides=List(v-%%3EPEOPLE,facetGeoRegion-%%3Ear%%3A0)&keywords=%s&origin=FACETED_SEARCH&q=guided&start=%i" % (
            search, p * 40)
...
if __name__ == '__main__':
    title = """
 __                               _  _____       _____ 
/ _\ ___ _ __ __ _ _ __   ___  __| | \_   \_ __ |___ / 
\ \ / __| '__/ _` | '_ \ / _ \/ _` |  / /\/ '_ \  |_ \ 
_\ \ (__| | | (_| | |_) |  __/ (_| /\/ /_ | | | |___) |
\__/\___|_|  \__,_| .__/ \___|\__,_\____/ |_| |_|____/ 
                  |_|                                                            
Python 3 tool to scrape linkedin v2.0
"""
    print(title)
